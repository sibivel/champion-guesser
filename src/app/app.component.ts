...
export class AppComponent {
  ...
  onGuess(event){
    if(event.guessedCorrectly){
      this.guessedCorrectly = true;
      this.showButton = true;
      this.nextButtonText = "Keep Going";
    }else if(event.guesses.length >= 3){
      this.guessedCorrectly = false;
      this.showButton = true;
      this.nextButtonText = "Try Again";
